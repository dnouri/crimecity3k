...
-- counts and sparse type-level details for client-side filtering.
--
-- Key features:
--   - JOIN by location_name (case-insensitive) to match events to municipalities
--   - LEFT JOIN from municipalities ensures all 290 appear (even with 0 events)
--   - Uses official SCB population data for rate calculations
